...
export const movies: MovieModel[] = [
...

  {
    ...
    description: ' Apărarea și acuzarea s-au odihnit, iar juriul se depune în sala de juri pentru a decide dacă un tânăr este vinovat sau nevinovat de uciderea tatălui său. Ceea ce începe ca un caz deschis și închis de crimă devine în curând o poveste detectivistă care prezintă o succesiune de indicii care creează îndoială și o mini-dramă a prejudecăților și preconcepțiilor fiecărui jurat cu privire la proces, acuzat ȘI unii pe alții . Pe baza piesei, toată acțiunea are loc pe scena sălii de juriu.',
  },

  {
    ...
    description: ' Într-un oraș de provincie adormit, o comunitate a Martorilor lui Iehova este atacată de un grup extremist. În mijlocul acestui conflict, lumea familiară a lui Yana, soția liderului comunității, se năruie încet. Nemulțumirea interioară a Yanei crește pe măsură ce se străduiește să-și dea sens dorințelor.',
  },
  {
    id: 6,
